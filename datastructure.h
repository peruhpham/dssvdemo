...
// //	for(int  i=0;i<lcfs.size;i++){
// //		outPut<<lcfs.list[i]->idSubject<<"#"<<lcfs.list[i]->academicYear<<"#"<<lcfs.list[i]->semester<<"#"<<lcfs.list[i]->group<<"#"<<lcfs.list[i]->studentMin<<"#"<<lcfs.list[i]->studentMax<<endl;
// //	}
// //	outPut.close();
// //	
// //}
...
// //	for(int  i=0;i<lcfs.size;i++){
// //		outPut<<lcfs.list[i]->idclass<<"#"; 
// //		ptrRegister r=lcfs.list[i]->lr->head;
// //		while(r!=NULL){
// //			outPut<<r->data.idStudent<<"#"<<r->data.scores<<"#"<<r->data.unSub<<endl;
// //			r=r->next;
// //			 
// //		} 
// //	}
...
// //void recordFileRegister(listClassForSubject lcfs){
// //	
// //} 
